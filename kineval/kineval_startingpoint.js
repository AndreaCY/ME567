...
kineval.startingPlaceholderUserInput = function startingPlaceholderUserInput() {
    ...
    */
    ...
    // STENCIL: update the radius of the jittering
        jitterRadius -= 0.005;
        jitterRadius = jitterRadius > 0 ? jitterRadius : 0; // it should stop when lower than 0
    }
    ...
    // STENCIL: update the global spacing variable
        spacingGlobal -= 0.01;
        spacingGlobal = spacingGlobal > 0 ? spacingGlobal : 0; // it should stop when lower than 0
    }
    ...
    // STENCIL: update the wave amplitude variable
        waveAmplitude -= 0.05;
        waveAmplitude = waveAmplitude > 0 ? waveAmplitude : 0; // it should stop when lower than 0
    }
    ...
    // STENCIL: update the global spacing variable
        waveFrequency -= 0.01;
        waveFrequency = waveFrequency > 0 ? waveFrequency : 0; // it should stop when lower than 0
    }
    else {
